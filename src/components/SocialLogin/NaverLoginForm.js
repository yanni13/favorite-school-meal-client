...
const NaverLoginForm = () => {
    ...
    const link = 'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=xQ6XMGVRxbFRU3GgqKaW&state=1234&redirect_uri=https://favorite-school.me/NaverLoginPage';
